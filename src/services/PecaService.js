const PecaRepository = require('../../../servicos-pecas/src/repositories/PecaRepository');
...
class PecaService {
  async criar({ nome, descricao, preco, quantidadeDisponivel }) {
    ...
    if (quantidadeDisponivel !== undefined && quantidadeDisponivel < 0) {
      throw new AppError('A quantidade disponível não pode ser negativa.');
    }
